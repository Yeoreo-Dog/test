import type { ThemeUpdateOptions } from 'src/theme/types';
import type { SettingsState } from 'src/components/settings';

import COLORS from 'src/theme/core/colors.json';
import { createPaletteChannel } from 'src/theme/styles';
...
import { primary as corePrimary, secondary as coreSecondary } from 'src/theme/core/palette';
import {
  createShadowColor,
  customShadows as coreCustomShadows,
} from 'src/theme/core/custom-shadows';
